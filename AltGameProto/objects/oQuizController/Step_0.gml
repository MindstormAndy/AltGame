...
if (global.found && !global.shuffle_buttons && mouse_check_button_pressed(mb_left))
{
	...
	else if (point_in_rectangle(mouse_gui_x, mouse_gui_y, button2x, button2y, button2x+button_width, button2y+button_height))
	{
		show_debug_message("2")
		global.found = false;
		UpdateBattery(shuffled_array, 1);
	}
	else if (point_in_rectangle(mouse_gui_x, mouse_gui_y, button3x, button3y, button3x+button_width, button3y+button_height))
	{
		show_debug_message("3")
		global.found = false;
		UpdateBattery(shuffled_array, 2);
	}
	else if (point_in_rectangle(mouse_gui_x, mouse_gui_y, button4x, button4y, button4x+button_width, button4y+button_height))
	{
